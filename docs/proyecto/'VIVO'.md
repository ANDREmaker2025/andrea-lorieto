...
La motivación base para la elección de este proyecto frente a otras inquietudes y oportunidades potenciales de ideación a desarrollar, radicó en el desafío personal y académico de desafiar mi zona de confort, de ir más allá (pudiendo no hacerlo) y optando por un proyecto que lograra sacarle el mayor provecho esta formación continua en este proceso de desarrollo a lo largo del posgrado, en áreas del conocimiento nuevas e inexploradas en el abordaje de la tecnología fabricación digital para mi: la principal, la dimensión _electrónica y el código de programación_, y en segundo plano, la _3Dprint_ y la mirada sobre _Diseño Distribuido_. 

Más allá de la infinidad de aspectos a enriquecer y aún por evolucionar del proyecto y su proceso de desarrollo, tengo a la vez, (en esta instancia de incubación alcanzada), la satisfacción de acierto, por haberme superado a misma; Habiendo transitado el objetivo propuesto, de ir más allá de lo conocido, de aprender haciendo, e intentando, sorteado el universo electrónico y lenguaje de programación, (proceso desafiante y sinuoso), que finalmente materialicé en un proyecto basado principalmente en esta dimensión.
