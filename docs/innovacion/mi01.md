...
# ❝ 
Inevitablemente la temática y desarrollo de este módulo, ha sido un pellizcón a mi manera de abordar la práctica creativa en la profesión del diseño/diseñadores como agente de cambio industrial para ampliar fronteras más allá! 
Influyó, invitando a cuestionarme en cuanto este cambio de paradigma sobre el 'cómo hacer’ con todo lo que eso implica, como crear/idear, cómo llevar a la práctica un proceso de creación desde la concepción de ideas hasta la proyección de desarrollo material final. 
