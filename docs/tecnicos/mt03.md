...
![](../images/MT03/MT03_FP01_simulador.png)
![](../images/MT01/.png) 

## **ENSAYOS** ~ LÁSER CNC

Desde el comienzo del MT03, me interesó aprovechar al máximo la técnica de fabricación sencilla como lo es Laser Cutting, razón por la cual generé para el proceso de práctica un pool de modelados vectoriales dviersos donde pudiera explorar la técnica de Kerf Bending y a partir de distintos cortes evaluar la funcionalidad sobre la material MDF.  

![](../images/MT03/MT03_FP01_movie.png)
[_FP01_LASER ENSAYOS_DEMO_](https://drive.google.com/file/d/1m1WrAsWL6d9VdOJcip3CiqfxbXHeqYui/view?usp=share_link)

![](../images/MT01/.png) 

### **ENSAYO LÁSER 1** ~ VECTOR #1
CORTE MISMO PATRÓN KERF ~ DIFERENTE MODELADO #1
...
### **ENSAYO LÁSER 2** ~ VECTOR #2
CORTE MISMO PATRÓN KERF ~ DIFERENTE MODELADO #2
...
### **ENSAYO LÁSER 3** ~ VECTOR #3
DISTINTOS PATRONES KERF ~ DIFERENTES MODELADOS 
...
El desafío de centrarme en nuevos aprendizajes atravesó por una serie de obstáculos y algunos errores técnicos del modelado vectorial experimentados durante la práctica de fabricación. Concretamente, producto del fallo en el **dibujo modelado del kerf**, siendo una réplica fiel paso a paso a partir del [tutorial](https://www.youtube.com/watch?v=nt-44j15xeI), aplicando las medidas literales y la fórmula de repetición del dibujo tutorial, pero errandole a la **relación de proporción del patrón modular del ranurado/kerf** (espacios, alturas, largos, superposición ranuras/vaciado). 
 Al priorizar esas dimensiones literales sugeridas -kerf tutorial- por encima de las proporciones conceptuales del patrón kerf, el kerfing/vaciado colapsó el material. Al diseñarlo/dibujarlo, creí que era necesario respetar y replicar las mismas medidas del patrón tutorial sugeridas como garantía de un kerf funcional al momento del corte más allá de la dimensión. 

![](../images/MT03/MT03_FP01_2.jpg)
![](../images/MT03/MT03_kerfversus2_WEB.png)
![](../images/MT03/MT03_FP01_3c.jpg)

**CORTE # 1 & 2**; A grandes rasgos el 'fallo' funcional del kerf, fue producto de haber proyectado el kerf literalmente a partir de un tutorial 'riguroso' para el dibujo modelado, a tal punto que **omití lo importante: lo relativo de la proporción en el diseño vs. el concepto de sustracción material**, dejando mi capacidad de modelar/dibujar el kerf de forma intuitiva, siguiendo ese camino hubiese dominado la operación Kerfing. **CORTE # 3**; si bien el dibujo de kerf 3 fue distinto (con mayor % de vaciado material), el 'fallo' estuvo en haber reducido al límite la capacidad de escala del modelado vectorial colapsando el material en el Kerfin.
