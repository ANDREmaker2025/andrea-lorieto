...
## **HERRAMIENTAS TECH DIG. APLICADAS .** MT03
![](../images/MT01/.png) 
...
### **ENSAYO LÁSER 3** 
CORTE ~ DISTINTO PATRONE KERF ~ DIFERENTE MODELADO/VECTOR #3
...
El desafío de centrarme en nuevos aprendizajes atravesó por una serie de obstáculos y algunos errores técnicos del modelado vectorial experimentados durante la práctica de fabricación. Concretamente, producto del fallo en el **dibujo modelado del kerf** (live hinge), fue hacer una réplica fiel paso a paso del [tutorial](https://www.youtube.com/watch?v=nt-44j15xeI), 
aplicando las medidas literales y una fórmula de patrón de dibujo sugerida, errándole a la 
**relación de proporción del patrón modular de ranurado/kerf vs. las características del material** (espacios, alturas, largos, superposición ranuras/vaciado). 
**Al priorizar esas dimensiones literales sugeridas del -kerf tutorial- por encima de las proporciones conceptuales del patrón kerf general, el kerfing/vaciado colapsó el material y la bisagra 'viva'.** 
Al diseñarlo/dibujarlo, creí que respetar y replicar las medidas idénticas del patrón tutorial sugeridas, sería garantía de un kerf funcional al momento del corte más allá de la dimensión. 
...
CNC _ laser + router + vinile _ FabAcademy ~ Riichiro Yamamoto
https://fabacademy.org/2024/labs/barcelona/students/riichiro-yamamoto/01_Task/Week3/W3_Documentation.html

Fab Academy ~ CNC
https://fablabbcn.org/blog/lab-life/fab-academy-computer-controlled-cutting
