...
Desde el comienzo del MT03, me interesó aprovechar al máximo la técnica de fabricación sencilla como lo es Laser Cutting, razón por la cual generé para el proceso de práctica un pool de modelados vectoriales donde pudiera explorar la técnica de Kerf Bending y a partir de cortes variados evaluar la funcionalidad sobre la material MDF.  
...
El desafío de centrarme en nuevos aprendizajes atravesó por una serie de obstáculos y algunos errores técnicos del modelado vectorial experimentados durante la práctica de fabricación. Concretamente, producto del fallo en el dibujo modelado del kerf, siendo una réplica fiel paso a paso a partir del tutorial XXXX (poner), aplicando las medidas literales y la fórmula de repetición del dibujo tutorial pero errandole a la relación de proporción del patrón modular del ranurado/kerf (espacios, alturas, largos, superposición ranuras). Al priorizar las dimensiones literales sugeridas del ranurado por encima de las proporciones del patrón ranurado general, el kerfing colapsó en la práctica. Creí que era necesario respetar y replicar las mismas medidas del patrón tutorial sugeridas como garantía de un kerf funcional al momento del corte más allá de la dimensión. 

![](../images/MT03/MT03_kerfversus2_WEB.png)

A grandes rasgos el fallo funcional del kerf (en ambos cortes), fue producto de haber proyectado el kerf literalmente a partir de un [tutorial](https://www.youtube.com/watch?v=nt-44j15xeI) 'riguroso' para el dibujo modelado, a tal punto que **omití lo importante: lo relativo de la proporción en el diseño vs. el concepto de sustracción material**, dejando mi capacidad de modelar/dibujar el kerf de forma intuitiva, siguiendo ese camino hubiese dominado la operación Kerfing. 
