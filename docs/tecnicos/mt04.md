...
Una vez instalado el [_Arduino IDE_]([https://](https://www.arduino.cc/en/software/)) software (MacOS AppleSilicon), incluimos el [_Board Package (Installing)_](https://https://docs.arduino.cc/software/ide-v2/tutorials/ide-v2-board-manager/) (o paquete de plataforma/placas), _**Arduino AVR Boards**_, un "Core" (núcleo), que añade funcionalidad (por medio de un conjunto de archivos de software) y permite que el entorno de desarrollo sea compatible con una familia específica de microcontroladores. Este paquete de placas son necesarios para que el [_Editor Arduino IDE_](https://docs.arduino.cc/software/ide-v2/tutorials/ide-v2-serial-monitor/) entienda cómo traducir el código al lenguaje específico del microprocesador. ```menú: [BOARDS MANAGER (PACKAGE) → Arduino AVR Boards``` 
