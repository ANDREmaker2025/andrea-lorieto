...
## **WS** . Weak Signals
# ❝ ![](../images/MD01/MD01_weaksignalsdef.png) ###### [^ fuente consultada](https://www.sciencedirect.com/science/article/pii/S0016328725000448) 
# ❞
...
## **REFLEXIONES .** MD01 
# ❝ 
Por la naturalidad implícita que existe en la maduración de las ideas durante los procesos creativos, pienso, que el AOWS junto a los Emergent Futures es una herramienta creativa que en la evolución continua de la investigación del proyecto se transforma o amplía su alcance aún mayor hacia una herramienta de análisis y de pensamiento crítico de proceso generativo del proyecto. En este sentido sería interesante explorar la aplicación de estas herramientas en distintos niveles de uso o profundizar nuevos alcances a medida que el proyecto crece hacia la investigación-acción. 
# ❞
