...
En este sentido, como el mood de un latido, el camino de avance sobre el proceso de diseño e ideación de proyecto tiene un pulso constante sino 'muere'; Un ritmo de avance para madurar y crecer aún más reflexionando acerca de otras dimensiones que lo configuran, como a través del **prototipado, de los tests y de potenciales intervenciones estratégicas transversales al proyecto. Podemos llegar a tener una línea de desarrollo translúcida, aunque no signifique que el proyecto** esté acabado, pero al menos mínimamente dilucidar una visión y propósito del proyecto más clara a seguir.
...
## **DINÁMICA 1** . PROPUESTA DE VALOR + JAM SESSION 
...
## **DINÁMICA 2** . IDEA PROYECTO + ESTRATEGIA DE VALIDACIÓN ~ PROTOTIPADO
